...
/* Nesta função o paraâmetro "forma" tem um valor predefinidor: 'R'. Assim, caso este parâmetro não seja informado, o valor 'R'
será usado se o parâmetro for informado, valerá o valor passado.*/
...
console.log(`Área elipse (círculo) 15x15: ${calcular_area(715,15,'E')}`)
...
/*  Regras para o uso de parâmetros predefinidos em funções:
    ...
    2. Pode haver mais de um parâmetro predefinido. Nesse caso, eles devem ser os ùltimos parâmetros da função. */